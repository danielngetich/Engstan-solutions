        ...
        <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-md">
            <strong class="block text-center text-xl font-medium text-gray-900 sm:text-3xl">
              Want us to email you with offers?
            </strong>
            ...
            <form class="mt-6">
              <div class="relative max-w-lg">
                ...
                <button
                  class="absolute top-1/2 right-1 -translate-y-1/2 rounded-full bg-blue-600 px-3 py-2 text-sm font-medium text-white transition hover:bg-blue-700"
                  type="button"
                >
                  Subscribe
                </button>
